...
export const BOOTCAMP_PLAN: MissionPlan[] = [
  ...
  // ── Phase 2 · Arrival ──
  { day: 7, phase: 2, title: T('שדה תעופה וצ׳ק-אין', 'Airport & Check-in'),
    objective: T('דלפק, מזוודה, שער, כרטיס עלייה — רגוע.', 'Counter, bag, gate, boarding pass — calm.'),
    confidenceGain: T('הטיסה מתחילה בשליטה.', 'The trip starts in control.'),
    situations: ['border'], targets: { concepts: 8, phrases: 4, dialogues: 1 },
    listeningSkill: 'gate/boarding announcements-lite', speakingSkill: 'check-in answers',
    minutes: 20, feeling: T('שדות תעופה זה תסריט.', 'Airports are a script.'),
    why: 'The first real moment of every trip; cheap to master (mostly recognition).',
    preparesNext: 'Authority-question pattern for passport control.' },
  { day: 8, phase: 2, title: T('ביקורת דרכונים', 'Passport Control'),
    objective: T('ארבע שאלות הגבול, בקור רוח.', 'The four border questions, coolly answered.'),
    ...
    minutes: 20, feeling: T('גבול זה בסך הכל שיחה של 40 שניות.', 'A border is just a 40-second chat.'),
  ...
  { day: 9, phase: 2, title: T('מונית', 'Taxi'),
    ...
    preparesNext: 'Completes the arrival chain for the checkpoint.' },
  { day: 10, phase: 2, checkpoint: true, title: T('נקודת ביקורת: יום הגעה', 'CHECKPOINT: Arrival Day'),
    objective: T('שרשור קר: שדה → דרכונים → מונית. בלי הכנה, בלי כתוביות מלאות.', 'Cold chain: airport → passport → taxi. Unannounced, minimal subtitles.'),
    confidenceGain: T('הוכחה: יום הגעה שלם — שריד.', 'Proof: a full arrival day, survivable.'),
    situations: ['border', 'taxi'], targets: { concepts: 0, phrases: 0, dialogues: 3 },
  ...
  { day: 11, phase: 2, title: T('צ׳ק-אין במלון', 'Hotel Check-in'),
    ...
    preparesNext: 'Hotel vocabulary for requests & problems.' },
  ...
  { day: 22, phase: 4, title: T('קניות ומידות', 'Shopping & Sizes'),
    objective: T('למדוד, להשוות, להחליט, להחזיר.', 'Try on, compare, decide, return.'),
