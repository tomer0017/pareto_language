...
const conceptSchema = new Schema<ConceptDoc>(
  {
    ...
    rank: Number,
    example: { type: Map, of: String },
    // Core Corpus metadata (Core 500) — additive, optional (schema: concept.ts).
    pos: String,
    commScore: Number,
    recogScore: Number,
    imageEligible: Boolean,
    aliases: { type: [String], default: undefined },
    relatedConcepts: { type: [String], default: undefined },
    oppositeConcepts: { type: [String], default: undefined },
    changelog: { type: [changelogSchema], default: [] },
  },
  { versionKey: false, timestamps: true },
);
